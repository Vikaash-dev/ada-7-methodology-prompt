...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/Vikaash-dev/ada-7-methodology-prompt)
...
2. Describe your project: "I want to build [your application]"
3. The AI will start with Stage 1 and guide you through each stage
4. Review deliverables at each stage before proceeding
5. Provide feedback and refinements as needed
```
